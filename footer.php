	...
	<div id="footer-widgets">
		...
		<div class="container">
			...
			<div class="row col center">
				...
				<?php } ?>
				<div class="col span_4 footer-logo center"><img src="/wp-content/uploads/2016/04/logo_3.png" alt="" /></div>
			</div><!--/row-->
		...
		<div class="row" id="copyright">
			...
			<div class="container">
				...
				<div class="col span_12 center">
					...
					<?php } else { ?>
						<p><a href="http://community.biddytarot.com/plain-terms/">Terms</a>. <a href="http://community.biddytarot.com/privacy-policy/">Privacy</a>. &copy; <?php echo date('Y') . ' ' . get_bloginfo('name'); ?>. <?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> </p>
<p style="text-align:center;">Webdesign and Development by <a href="http://www.gifdesignstudios.com/" target="_blank">GiF Design Studios</a></p>
					<?php } ?>
