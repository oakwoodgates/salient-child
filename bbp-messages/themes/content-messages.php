...
<div class="single-pm">
	...
	<div class="bbpm-single-top bbpm-top-header">
		...
		<a href="<?php echo bbpm_bbp_get_user_profile_url( bbpm_get_recipient()->ID ); ?>" title="View <?php echo bbpm_get_recipient()->first_name; ?>'s profile">
			<?php echo get_avatar( bbpm_get_recipient()->ID, apply_filters( 'bbpm_conversation_recipient_avatar_size', 30 ) ); ?>
			<span><?php echo bbpm_get_recipient()->first_name; ?></span>
		</a>
		&middot;
